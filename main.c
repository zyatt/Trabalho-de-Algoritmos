...
int main()
{
    ...
    // Ficou um pouco grande pois não sei ainda usar algumas funcionalidades da linguagem C.
    ...
    do {
        ...
        switch(menu){
            ...
            case 1:
                ...
                do{ // Loop infinito até a condição de parada.
                    voltar_sair2=0;
                    voltar_sair=0;
                    ...
                    while(k<=84){
                        printf("%c ",k); // Imprime a primeira linha com letras de A-T (com uso da tabela ASCII) para identificação de cada posição y.
                        k++;
                    }
                    printf("\n");
                            ...
                            do{ // Laço de repetição.
                                ...
                                if(aviao==AVMAX){
                                    ...
                                    switch(virar){ // switch case para rotação do elemento.
                                        case 1: // Opcão padrão:
                                            if(linha<1 || linha>18 || coluna>19){ // Condição que lê se o elemento pode ser impresso inteiramente na matriz.
